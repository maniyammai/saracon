...
<body class="<?php echo $this['config']->get('body_classes'); ?>"> 
	...
	<div id="tm-toolbar" class="tm-block tm-toolbar-bg" >
		...
		<div class="tm-toolbar uk-clearfix uk-hidden-small">
			...
			<?php if ($this['widgets']->count('toolbar-l')) : ?>
				<div class="uk-float-left time uk-hidden-small"><time datetime="<?php echo $this['config']->get('datetime'); ?>"><?php echo $this['config']->get('actual_date'); ?></time></div>
	...
	<div id="tm-bottom-a1" class="tm-block tm-block-bottom-a1">
		<section class="<?php echo $grid_classes['bottom-a1']; echo $display_classes['bottom-a1']; ?>" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin><?php echo $this['widgets']->render('bottom-a1', array('layout'=>$this['config']->get('grid.bottom-a1.layout'))); ?></section>
		</div>
		<?php endif; ?>
