<?php
/**
* @subpackage  tc_theme16 Template
*/
...
.($sliders_thumb1 ? '<div class="ls-slide" data-ls="slidedelay:5000;transition2d:5;"><img src="'.$sliders_thumb1.'" class="ls-bg" alt=""/>' : '')
.($sliders_thumb1 ? '</div>' : '')

.($sliders_thumb2 ? '<div class="ls-slide" data-ls="slidedelay:5000;transition2d:5;"><img src="'.$sliders_thumb2.'" class="ls-bg" alt=""/>' : '')
.($sliders_thumb2 ? '</div>' : '')

.($sliders_thumb3 ? '<div class="ls-slide" data-ls="slidedelay:5000;transition2d:5;"><img src="'.$sliders_thumb3.'" class="ls-bg" alt=""/>' : '')
.($sliders_thumb3 ? '</div>' : '')

.($sliders_thumb4 ? '<div class="ls-slide" data-ls="slidedelay:5000;transition2d:5;"><img src="'.$sliders_thumb4.'" class="ls-bg" alt=""/>' : '')
.($sliders_thumb4 ? '</div>' : '')

.($sliders_thumb5 ? '<div class="ls-slide" data-ls="slidedelay:5000;transition2d:5;"><img src="'.$sliders_thumb5.'" class="ls-bg" alt=""/>' : '')
.($sliders_thumb5 ? '</div>' : '').
'</div></div></div>
<script>
...
skin: "v5",
hoverBottomNav: true,
skinsPath: "'.$base_url.'/templates/tc_theme16/slider/skins/"
});
</script>' : '')
?>
