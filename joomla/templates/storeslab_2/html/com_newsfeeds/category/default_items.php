...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="category table table-bordered table-hover">
		...
		<?php endif; ?>
					...
					<td class="item-title">
						<a class="dboxname" href="<?php echo JRoute::_(NewsFeedsHelperRoute::getNewsfeedRoute($item->slug, $item->catid)); ?>">
					...
					<?php  if ($this->params->get('show_link')) : ?>
						<td class="item-link">
							<a class="dboxname" href="<?php echo $item->link; ?>"><?php echo $item->link; ?></a>
						</td>
					<?php  endif; ?>
