...
<li <?php echo $active_menu ?>>
	<div >
		<?php echo JHTML::link($caturl, $cattext, array('class'=>'oboxbr'));
		if ($category->childs) {
			?>
			<span class="VmArrowdown boxprice"></span>
			<?php
		}
		?>
	</div>
...
<li>
	<div ><?php echo JHTML::link($caturl, $cattext,  array('class'=>'oboxbr')); ?></div>
</li>
<?php		} ?>
</ul>
<?php 	} ?>
