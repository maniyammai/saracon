		...
		<fieldset>
			...
			<dl>
				...
				<?php 	if ($this->params->get('show_email_copy')){ ?>
						<dt style="float:left; display:block;"><?php echo $this->form->getLabel('contact_email_copy'); ?></dt>
						<dd style="float:left; float:left; display:block; width:2%; vertical-align:middle;"><?php echo $this->form->getInput('contact_email_copy'); ?></dd>
				<?php 	} ?>
			<?php //Dynamically load any additional fields from plugins. ?>
			     ...
			     <?php endforeach;?>
				<dt></dt>
				<dd><button class="button validate boxcart boxcartbt box4br_radius boxcart_shadow" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
