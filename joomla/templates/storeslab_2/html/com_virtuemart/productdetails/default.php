...
<div class="productdetails-view productdetails box5bg box5br box5bg_shadow box5br_radius">
	...
	?>
	<div class="back-to-category">  <?php
    // Product Edit Link
    echo $this->edit_link;
    // Product Edit Link END
    ?>
    	<a href="<?php echo $catURL ?>" class="product-details quickbtn boxcart boxcartbt box4br_radius boxcart_shadow" title="<?php echo $categoryName ?>"><?php echo JText::sprintf('COM_VIRTUEMART_CATEGORY_BACK_TO',$categoryName) ?></a>
...
?>
	...
	<div class="span6">
        ...
        <?php // Product Title   ?>
    <h1 class="boxname tlmbfoxname"><?php echo $this->product->product_name ?></h1>
...
if (VmConfig::get('ask_question', 1) == 1) {
    ?>
    		<div class="ask-a-question">
    		  <a class="ask-a-question modal quickbtn boxcart boxcartbt box4br_radius boxcart_shadow" rel="{handler: 'iframe', size: {x: 700, y: 550}}" href="<?php echo $this->askquestion_url ?>"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL') ?></a>
    		</div>
		<?php }
		?>
		<?php
   ...
   <li class="active dboxname"><a class="dboxname" href="#tab1" data-toggle="tab"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DESC_TITLE') ?></a></li>
   <li class="dboxname"><a class="dboxname" href="#tab2" data-toggle="tab"><?php echo JText::_ ('COM_VIRTUEMART_REVIEWS') ?></a></li>
   <li class="dboxname"><a class="dboxname" href="#tab3" data-toggle="tab"><?php echo JText::_('COM_VIRTUEMART_RELATED_PRODUCTS'); ?></a></li>
   </ul>
   ...
   <div class="product-description tab-pane active" id="tab1">
	...
	<div style="padding:10px;"><?php echo $this->product->product_desc; ?></div>
	<?php
...
<?php
	...
	?>  	<div class="clear"></div>
		...
		echo JHTML::_('link', $prev_link, $this->product->neighbours ['previous'][0]
			['product_name'], array('class' => 'dboxname previous-page'));
	    }
		...
		echo JHTML::_('link', $next_link, $this->product->neighbours ['next'][0] ['product_name'], array('class' => 'dboxname next-page'));
	    }
	    ?>
    	<div class="clear"></div>
        </div>
