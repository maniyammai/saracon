		...
		<?php foreach ($this->items as $i => $article) : ?>
			...
			<?php endif; ?>
				<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<td class="list-title">
						<a class="dboxname" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid)); ?>">
				...
				<?php else : // Show unauth links. ?>
					<td>
						...
						?>
						<a class="dboxname" href="<?php echo $fullURL; ?>" class="register">
