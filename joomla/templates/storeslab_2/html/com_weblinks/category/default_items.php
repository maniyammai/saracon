				...
				<?php
					...
					switch ($item->params->get('target', $this->params->get('target')))
					{
						case 1:
							...
							echo '<a class="dboxname" href="'. $link .'" target="_blank" class="'. $menuclass .'" rel="nofollow">'.
						...
						case 2:
							...
							echo "<a class=\"dboxname\" href=\"$link\" onclick=\"window.open(this.href, 'targetWindow', '".$attribs."'); return false;\">".
								$this->escape($item->title).'</a>';
							break;
						case 3:
							// open in a modal window
							JHtml::_('behavior.modal', 'a.modal'); ?>
							<a class="modal dboxname" href="<?php echo $link;?>"  rel="{handler: 'iframe', size: {x:<?php echo $this->escape($width);?>, y:<?php echo $this->escape($height);?>}}">
