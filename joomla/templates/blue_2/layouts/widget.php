...
// Set title
if (in_array($widget->position, array('headerbar', 'toolbar-l' ,'toolbar-r','footer-l', 'footer-r'))) {
	$title = '';
...
if ($widget->menu) {
	...
	} else if (in_array($widget->position, array('toolbar-l', 'toolbar-r','footer-l', 'footer-r'))) {
		$renderer = 'subnav';
