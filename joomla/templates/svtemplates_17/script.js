...
resizeData['slogan'] = {
   responsive: [
                  { left: 0.48, top: 0.68, visible: true }, 
                  { left: 0.48, top: 0.68, visible: true }, 
                  { left: 0.48, top: 0.68, visible: true }, 
                  { left: 0.48, top: 0.68, visible: true }, 
                  { left: 0.48, top: 0.68, visible: true }, 
...
resizeData['positioncontrol-1586082665'] = {
   responsive: [
                  { left: 0.01, top: 0.6, visible: true }, 
                  { left: 0.01, top: 0.6, visible: true }, 
                  { left: 0.01, top: 0.6, visible: false }, 
                  { left: 0.01, top: 0.6, visible: false }, 
                  { left: 0.01, top: 0.6, visible: false }, 
               ],
   area: {
...
resizeData['positioncontrol-704743695'] = {
   responsive: [
                  { left: 0.99, top: 0.7, visible: true }, 
                  { left: 0.99, top: 0.7, visible: true }, 
                  { left: 0.99, top: 0.7, visible: false }, 
                  { left: 0.99, top: 0.7, visible: false }, 
                  { left: 0.99, top: 0.7, visible: false }, 
               ],
   area: {
